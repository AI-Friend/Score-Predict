# -*- coding: utf-8 -*-
"""
Created on Wed Dec 20 21:34:19 2017 
...
file_score = open("SVM Rank/data/Score Predict.csv")
file_book = open("SVM Rank/data/Book Predict.csv")
file_card = open("SVM Rank/data/Card Predict.csv")
file_library = open("SVM Rank/data/Library Predict.csv")
file_feature_Predict = open("SVM Rank/data/Predict_110NUM_SVM.dat","w")
...
def Extract_Book(file):
    ...
    max_num_class = ""
    max_num = 0
    book_class_file = open("SVM Rank/data/book class.txt",encoding = "utf-8")
    first_line = 0
