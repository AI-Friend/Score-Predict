# -*- coding: utf-8 -*-
"""
Created on Wed Dec 20 20:06:19 2017 
...
file_score = open("SVM Rank/data/Score Train.csv")
file_book = open("SVM Rank/data/Book Train.csv")
file_card = open("SVM Rank/data/Card Train.csv")
file_library = open("SVM Rank/data/Library Train.csv")
file_feature_train = open("SVM Rank/data/Train_110NUM_SVM.dat","w")
