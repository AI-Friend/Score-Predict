# -*- coding: utf-8 -*-
"""
Created on Mon Jan 22 11:10:36 2018
...
file_score2 = open("SVM Rank/result/SVM Rank(rbf).txt")

file_score_write = open("bagging_(Lasso Rank)"+str(Weights[0])+"_SVM Rank"+str(Weights[1])+".txt", "w")
