# -*- coding: utf-8 -*-
"""
Created on Mon Mar 05 19:47:40 2018
...
file_score1 = open("AdaBoosting.txt")
file_score2 = open("bagging_(Lasso Rank)0.9_Basic Rule0.1.txt")

file_score_write = open("Final Result.txt", "w")
